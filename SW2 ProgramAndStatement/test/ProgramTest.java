...
public abstract class ProgramTest {
    ...
    private static final String TEST1 = "doc/program-test.bl";
    private static final String TEST2 = "doc/program-test2.bl";
    ...
    public final void testName1() {
         ...
         * Setup
         */
        Program pTest = this.createFromFileTest(TEST1);
        Program pRef = this.createFromFileRef(TEST1);
    ...
    public final void testName2() {
         ...
         * Setup
         */
        Program pTest = this.createFromFileTest(TEST2);
        Program pRef = this.createFromFileRef(TEST2);
