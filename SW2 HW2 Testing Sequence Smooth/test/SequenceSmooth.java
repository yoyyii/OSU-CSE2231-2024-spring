...
public final class SequenceSmooth {
    ...
    /*
     * challenge: s1 and s2 contains negative numbers
     */
    @Test
    public void test4() {
        /*
         * Set up variables and call method under test
         */
        Sequence<Integer> seq1 = this.createFromArgs(7, -1, -2, 3);
        Sequence<Integer> expectedSeq1 = this.createFromArgs(7, -1, -2, 3);
        Sequence<Integer> seq2 = this.createFromArgs(2, -5, -4);
        Sequence<Integer> expectedSeq2 = this.createFromArgs(3, -1, 0);
        SequenceSmooth.smooth(seq1, seq2);
        /*
         * Assert that values of variables match expectations
         */
