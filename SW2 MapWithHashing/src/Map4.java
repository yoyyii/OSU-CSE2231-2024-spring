...
public class Map4<K, V> extends MapSecondary<K, V> {
    ...
    public final void add(K key, V value) {
        ...
        // TODO - fill in body
        int hashValue = mod(key.hashCode(), this.hashTable.length);
        this.hashTable[hashValue].add(key, value);
        this.size++;
    }
    ...
    public final Pair<K, V> remove(K key) {
        ...
        // TODO - fill in body
        int hashValue = mod(key.hashCode(), this.hashTable.length);
        Map.Pair<K, V> remove = this.hashTable[hashValue].remove(key);
        this.size--;
        return remove;
    }
    ...
    public final Pair<K, V> removeAny() {
        ...
        this.size--;
        return this.hashTable[hashValue].removeAny();
    }
    ...
    public final V value(K key) {
        ...
        // TODO - fill in body
        int hashValue = mod(key.hashCode(), this.hashTable.length);
        return this.hashTable[hashValue].value(key);
    }
    ...
    public final boolean hasKey(K key) {
        ...
        // TODO - fill in body
        int hashValue = mod(key.hashCode(), this.hashTable.length);
        return this.hashTable[hashValue].hasKey(key);
    }
