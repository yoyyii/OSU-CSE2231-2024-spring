...
public final class SequencePalindrome {
    ...
    private static boolean isPalindrome(Sequence<Integer> s) {
         ...
         * boolean result = true;
         *
         * for (int i = 0, j = s.length() - 1; i < j && result; i++, j--) { int
         * front = s.remove(i); int back = s.remove(j - 1);
         *
         * if (front != back) { result = false; }
         *
         * s.add(i, front); s.add(j, back); }
         *
         * return result;
         */
